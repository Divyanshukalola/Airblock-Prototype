...
const Team_side_nav_worker = (props) => {
  const styleTag = {
    backgroundImage:
      "linear-gradient(to right, rgba(154, 189, 255, 0.199) 1%, rgba(255, 255, 255, 0.13) 99%)",
    borderLeftStyle: "solid",
    borderLeftColor: "rgba(0, 89, 255, 0.74)",
  };
  ...
  return (
    <>
      {/* Worker Team Side Nav  */}

      <div
        className="card sticky-top"
        style={{ height: "100vh", borderColor: "transparent" }}
      >
        <div className="body">
          <div className="container text-center my-3">
            <a className="navbar-brand" href="#">
              <img
                src={require("../../../static/img/cube.png")}
                width="70"
                height="70"
                alt=""
              />
          ...
          >
            <div
              className="container  nav-verticle"
              style={props.dashboard == "true" ? styleTag : null}
            >
              <div
                className="card"
                style={{
              ...
              >
                <div
                  ...
                  style={{ fontWeight: "bolder", color: "#757575" }}
                >
                  <div className="row">
                    <div className="col-1">
          ...
          >
            <div
              className="container  nav-verticle"
              style={props.projects == "true" ? styleTag : null}
            >
              <div
                className="card"
                style={{
          ...
          <a
            href="javascript:void(0)"
            onClick={() => props.setView("document")}
            style={{ textDecoration: "none", color: "black" }}
          >
            <div
              className="container  nav-verticle"
              style={props.document == "true" ? styleTag : null}
            >
              <div
                className="card"
                style={{
              ...
              >
                ...
                >
                  <div className="row">
                    ...
                    <div className="col">Documents</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div
              className="container  nav-verticle"
              style={props.calendar == "true" ? styleTag : null}
            >
              <div
                className="card"
                style={{
...
export default Team_side_nav_worker